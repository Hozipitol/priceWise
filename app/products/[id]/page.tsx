      ...
      <div className="flex gap-28 xl:flex-row flex-col">
        ...
        <div className='flex flex-col gap-16'>
          <div className='flex flex-col gap-5'>
            <h3 className='text-2xl text-secpndary font-semibold'>Product description</h3>
            <div className="flex flex-col gap-4">
              {product.description?.split('\n')}
            </div>
          </div>

          <button className='btn mx-auto w-fit flex items-center justify-center gap-3 min-w-[200px] mb-3'>
            <Image
